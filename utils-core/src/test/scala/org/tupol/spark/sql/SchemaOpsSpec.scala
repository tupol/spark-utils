...
class SchemaOpsSpec extends AnyFunSuite with Matchers {
  ...
  test("mapFields & checkAllFields") {
    ...
    val schema = StructType(
      (
        Seq(
                        ...
                        StructField(
                          ...
                          StructType(
                            Seq(
                              ...
                              StructField("col3213", StringType, false)
                            )
                          ),
                          false
                        ),
                          ...
                          ArrayType(
                            StructType(
                              Array(
                                ...
                                StructField("col3222", StringType, false)
                              )
                            ),
                            false
                          )
          ...
          StructField(
            "col4",
            MapType(StringType, StructType(Seq(StructField("col4v", StringType, false))), false),
            false
          )
        )
      )
    ...
    val schemaNullFields =
      mapFields(schema, (field: StructField) => field.copy(nullable = true)).asInstanceOf[StructType]
      ...
      (
        Seq(
          ...
          StructField(
            ...
            MapType(
              StringType,
              StructType(Seq(StructField("col4v", StringType, true))),
              false // This one is true
            ),
            false
          )
        )
